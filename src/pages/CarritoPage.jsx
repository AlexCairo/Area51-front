...
const CarritoPage = () => {
    ...
    useEffect(() => {
        ...
        const nSubTotal = lista.reduce((previousValue, currentObj) => {
            return previousValue + (currentObj.price*currentObj.quantity);
        },initValue);
                ...
                {lista.length <= 0 ? <div className="carrito-sinProductos"><PiHandbagDuotone className="icon-sinProductos" />No tienes productos añadidos <button onClick={handleBack} className="btn-seguirComprando">Seguir comprando</button></div>
                 ...
                 <div className="carrito-productos">                   
                    ...
                    <div className="carrito-info-resumen">
                                ...
                                <div className="sub-info-estimacion-impuestos">
                                    ...
                                    <div className="info-estadoCiudad">
                                        ...
                                        >
                                            ...
                                            <option key={provincia.id} value={provincia.shipping_cost}>
                                                {provincia.name}
                                            </option>
                                            ))}
                                        </select>
                                    ...
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style={{padding : ".5rem 0"}}>S/{isChecked && selectedProvincia ? "00" : selectedProvincia}.00</td>
                                            </tr>
                                            <tr>
                        ...
                        <button disabled={!selectedDistrito || !selectedDepartamento || !selectedProvincia} className={`button-realizarPedido`}>Realizar pedido</button>
                    </div>
                    </>}
            </section>
    );
